...
Route::get('wikicullture/post',[PostController::class, 'edit1']);
...
// Route::get('backend/post',[PostController::class, 'edit']);
// Route::post('backend/post',[PostController::class, 'update']);
// Settings
